...
print("Insert all values in SI units")
def distances(d, A1, A2, m1, m2):  
   ...
   dr31da = (((R*(np.cos(A1 + 4*np.pi)-np.cos(A2)))-d)*(R*np.sin(A2))-R*(np.sin(A1 + 4*np.pi)-np.sin(A2))*(R*np.cos(A2)))/r31**5
   dr32da = (((R*(np.cos(A1 + 4*np.pi)-np.cos(A2 + 2*np.pi)))-d)*(R*np.sin(A2 + 2*np.pi))-R*(np.sin(A1 + 4*np.pi)-np.sin(A2 + 2*np.pi))*(R*np.cos(A2 + 2*np.pi)))/r32**5
   dr33da = (((R*(np.cos(A1 + 4*np.pi)-np.cos(A2 + 4*np.pi)))-d)*(R*np.sin(A2 + 4*np.pi))-R*(np.sin(A1 + 4*np.pi)-np.sin(A2 + 4*np.pi))*(R*np.cos(A2 + 4*np.pi)))/r33**5
...
R = 0.041
#float(input("radius of spinner/s:"))
#moment of inertia of spinners I
#I_user = float(input("[put 0 for default value]\nmoment of inertia of spinner:"))
#if I_user == 0:
I = 1.38*10**-5
#else:
  #  I = I_user
#magnetic moment m
#m_user = float(input("[insert 0 for default value\nmagnetic moment:"))
#if m_user == 0:
m = 0.2 #0.54
#else:
#    m = m_user
...
for i in range (1, n_steps + 1): 
    if n0 == 2:
        ...
        dUda12 = distances(d12, a1_arr[i-1], a2_arr[i-1], 1, 2) 
    ...
    if n0 == 3:
        ...
        dUda12 = distances(d12 , a1_arr[i-1], a2_arr[i-1], 1, 2)
        dUda23 = distances(d23 , a2_arr[i-1], a3_arr[i-1], 2, 3)
        dUda13 = distances(d13 , a1_arr[i-1], a3_arr[i-1], 1, 3)
    ...
    if n0 == 4:
        d12 = ((x1 - x2)**2 + (y1 - y2)**2)**(1/2)
        d13 = ((x1 - x3)**2 + (y1 - y3)**2)**(1/2)
        d14 = ((x1 - x4)**2 + (y1 - y4)**2)**(1/2)
        d23 = ((x3 - x2)**2 + (y3 - y2)**2)**(1/2)
        d24 = ((x2 - x4)**2 + (y2 - y4)**2)**(1/2)
        d34 = ((x3 - x4)**2 + (y3 - y4)**2)**(1/2)
        dUda12 = distances(d12, a1_arr[i-1], a2_arr[i-1], 1, 2)
        dUda13 = distances(d13, a1_arr[i-1], a3_arr[i-1], 1, 3)
        dUda14 = distances(d14, a1_arr[i-1], a4_arr[i-1], 1, 4)
        dUda23 = distances(d23, a2_arr[i-1], a3_arr[i-1], 2, 3)
        dUda24 = distances(d24, a2_arr[i-1], a4_arr[i-1], 2, 4)
        dUda34 = distances(d34, a3_arr[i-1], a4_arr[i-1], 3, 4)
    ...
    if n0 == 5:
        ...
        d13 = ((x1 - x3)**2 + (y1 - y3)**2)**(1/2)
        d14 = ((x1 - x4)**2 + (y1 - y4)**2)**(1/2)
        d15 = ((x1 - x5)**2 + (y1 - y5)**2)**(1/2)
        d23 = ((x3 - x2)**2 + (y3 - y2)**2)**(1/2)
        d24 = ((x2 - x4)**2 + (y2 - y4)**2)**(1/2)
        d25 = ((x2 - x5)**2 + (y2 - y5)**2)**(1/2)
        d34 = ((x3 - x4)**2 + (y3 - y4)**2)**(1/2)
        d35 = ((x3 - x5)**2 + (y3 - y5)**2)**(1/2)
        d45 = ((x5 - x4)**2 + (y5 - y4)**2)**(1/2)
    ...
    if n0== 6:
        ...
        d14 = ((x1 - x4)**2 + (y1 - y4)**2)**(1/2)
        d15 = ((x1 - x5)**2 + (y1 - y5)**2)**(1/2)
        d16 = ((x1 - x6)**2 + (y1 - y6)**2)**(1/2)
        d23 = ((x3 - x2)**2 + (y3 - y2)**2)**(1/2)
        d24 = ((x2 - x4)**2 + (y2 - y4)**2)**(1/2)
        d25 = ((x2 - x5)**2 + (y2 - y5)**2)**(1/2)
        d26 = ((x2 - x6)**2 + (y2 - y6)**2)**(1/2)
        d34 = ((x3 - x4)**2 + (y3 - y4)**2)**(1/2)
        d35 = ((x3 - x5)**2 + (y3 - y5)**2)**(1/2)
        d45 = ((x5 - x4)**2 + (y5 - y4)**2)**(1/2)
        d46 = ((x4 - x6)**2 + (y4 - y6)**2)**(1/2)
        d56 = ((x6 - x5)**2 + (y6 - y5)**2)**(1/2)
        dUda12 = distances(x1, x2, y1, y2, a1_arr[i-1], a2_arr[i-1], 1, 2)
        dUda13 = distances(x1, x3, y1, y3, a1_arr[i-1], a3_arr[i-1], 1, 3)
        dUda14 = distances(x1, x4, y1, y4, a1_arr[i-1], a4_arr[i-1], 1, 4)
        dUda15 = distances(x1, x5, y1, y5, a1_arr[i-1], a5_arr[i-1], 1, 5)
...
for n in range (1, n0 + 1):
    ...
    #plt.plot(t_arr, vars()["v" + str(n) + "_arr"], linewidth = 4, label = 'v spinner ' + str(n))    # plot P to t
    plt.plot(t_arr, vars()["a" + str(n) + "_arr"], linewidth = 4, label = 'a spinner ' + str(n))  
